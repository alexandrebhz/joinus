...
The test suite covers **23 endpoints** across all API categories:
- ✅ Health Check (1 endpoint)
- ✅ Authentication (3 endpoints: Register, Login, Refresh Token)
- ✅ User Management (1 endpoint: Get Current User)
- ✅ Startup Operations (5 endpoints: Create, List, Get by ID, Get by Slug, Update)
- ✅ Job Operations (5 endpoints: Create, List, List with Filters, Update, Delete)
- ✅ File Upload (1 endpoint)
- ✅ Public Routes (2 endpoints: List Startups, List Jobs)
- ✅ Token-Based Routes (5 endpoints: Get Startup, List/Create/Update/Delete Jobs)

**Total Coverage: 100% of available endpoints**
